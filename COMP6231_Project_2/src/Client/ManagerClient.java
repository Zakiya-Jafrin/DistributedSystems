...
//        HashMap<String, Integer> eventMap;
        ...
        while (userSelection != 8) {
            switch (userSelection) {
                case 1:
                    status = eventObj.addEvent("MTLM1234", "MTLA123456", "SEMINAR", 2);
...
//                            Arrays.asList(user, eventId, ET, eventCapacity), status, Constants.EMPTYSTRING));
                    if (status)
                        ...
                        System.out.println("CAPACITY UPDATED = " + "MTLA12345" + " is already offered in " + "SEMINAR" + " EventType.");
//                        System.out.println("CAPACITY UPDATED = " + eventId + " is already offered in " + ET + " EventType.");
                ...
                case 3:
                    ...
                    for (String element: eventMap) {
                        String event = (element.substring(0,element.length() - 2))+" ";
                        String eventC = element.substring(element.length() - 2);
                        sb.append(event);
                        sb.append(eventC);
                        sb.append(",");
                    }
                ...
                case 6:
                    ...
                    eventMap = eventObj.cancelEvent(customerId, eventId, eventType);
