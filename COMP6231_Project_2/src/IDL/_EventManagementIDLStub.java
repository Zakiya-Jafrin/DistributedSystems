...
/**
* IDL/_EventManagementIDLStub.java .
...
public class _EventManagementIDLStub extends org.omg.CORBA.portable.ObjectImpl implements IDL.EventManagementIDL
{
  ...
  public String[] listEventAvailability (String managerID, String eventType)
  {
            ...
            try {
                ...
                $out.write_string (eventType);
                $in = _invoke ($out);
                String $result[] = IDL.ResultListHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
