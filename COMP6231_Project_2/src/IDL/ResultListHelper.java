...
{
  private static String  _id = "IDL:IDL/ResultList:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (IDL.ResultListHelper.id (), "ResultList", __typeCode);
    }
    return __typeCode;
  }
