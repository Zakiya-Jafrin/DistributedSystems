...
@WebService(endpointInterface = "com.web.service.InterfaceEventManagement")
@SOAPBinding(style = SOAPBinding.Style.RPC)

public class EventManagement implements InterfaceEventManagement{
    ...
    public HashMap<String, Integer> listEventAvailabilityMap(String managerId, String eventType){
    ...
    private SimpleEntry<Boolean, String> swapEventMap (String customerId, String newEventId, String newEventType,
...
;
    ...
    private SimpleEntry<Boolean, String> bookEventMap(String customerId, String eventId, String eventType){
