...
//                                result = (AbstractMap.SimpleEntry<Boolean, String>)
//                                        rm.communication(eventCity, data, Constants.OP_BOOK_EVENT);
                            }
                        }
                        break;
                    }
...
//                    }
//                }
//                if(this.City.toString().equals( "MTL"))
//                    cityDatabase = RMTwo.MTLObject.cityDatabase;
//                if(this.City.toString().equals( "TOR"))
//                    cityDatabase = RMTwo.TORObject.cityDatabase;
//                if(this.City.toString().equals( "OTW"))
//                    cityDatabase = RMTwo.OTWObject.cityDatabase;
            }
        }
        if (result == null)
